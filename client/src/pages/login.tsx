            ...
            <div className="mt-6">
              ...
              <div className="mt-4">
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-white dark:bg-gray-800 text-gray-500">New to SmartRent?</span>
                  </div>
                </div>

                <div className="mt-6">
                  <Button variant="outline" className="w-full" asChild data-testid="button-register">
                    <Link href="/register">
                      Create an account
                    </Link>
                  </Button>
